...
app.UseStaticFiles(); //root kullanýlacak demektir.


app.UseAuthentication(); // Login-Logout iþlemleri için ve Claim
app.UseAuthorization(); // Yalnýzca admin yönetim paneline gidebilsin.
